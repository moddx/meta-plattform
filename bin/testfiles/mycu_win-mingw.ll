...
$_ZTS13MyComputeData = comdat any

$_ZTI13MyComputeData = comdat any

$_ZTS13MyComputeUnit = comdat any

$_ZTSN4META4Core11ComputeUnitE = comdat any

$_ZTIN4META4Core11ComputeUnitE = comdat any

$_ZTI13MyComputeUnit = comdat any
...
@_ZTS13MyComputeData = linkonce_odr dso_local constant [16 x i8] c"13MyComputeData\00", comdat
@_ZTI13MyComputeData = linkonce_odr dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @_ZTS13MyComputeData, i32 0, i32 0), i8* bitcast ({ i8*, i8* }* @_ZTIN4META4Core11ComputeDataE to i8*) }, comdat
...
@_ZTS13MyComputeUnit = linkonce_odr dso_local constant [16 x i8] c"13MyComputeUnit\00", comdat
...
@_ZTI13MyComputeUnit = linkonce_odr dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @_ZTS13MyComputeUnit, i32 0, i32 0), i8* bitcast ({ i8*, i8* }* @_ZTIN4META4Core11ComputeUnitE to i8*) }, comdat
@llvm.global_ctors = appending global [0 x { i32, void ()*, i8* }] zeroinitializer

; Function Attrs: uwtable
define dso_local noalias %"class.META::Core::ComputeData"* @_Z16newMyComputeDatav() #0 {
  %1 = tail call i8* @_Znwy(i64 16) #6
  tail call void @llvm.memset.p0i8.i64(i8* align 16 %1, i8 0, i64 16, i1 false)
...
declare dso_local noalias i8* @_Znwy(i64) local_unnamed_addr #1
...
define dso_local void @_ZN13MyComputeData10fromStringENSt3__112basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEE(%class.MyComputeData* nocapture, %"class.std::__1::basic_string"*) unnamed_addr #0 align 2 {
  %3 = tail call i32 @_ZNSt3__14stoiERKNS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEEPyi(%"class.std::__1::basic_string"* dereferenceable(24) %1, i64* null, i32 10)
  %4 = getelementptr inbounds %class.MyComputeData, %class.MyComputeData* %0, i64 0, i32 1
  store i32 %3, i32* %4, align 8, !tbaa !6
  ret void
}

declare dllimport i32 @_ZNSt3__14stoiERKNS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEEPyi(%"class.std::__1::basic_string"* dereferenceable(24), i64*, i32) local_unnamed_addr #3
...
declare dllimport void @_ZNSt3__19to_stringEi(%"class.std::__1::basic_string"* sret, i32) local_unnamed_addr #3
...
; Function Attrs: uwtable
define dso_local noalias %"class.META::Core::ComputeData"* @_ZNK13MyComputeUnit7computeEPN4META4Core11ComputeDataE(%class.MyComputeUnit* nocapture readnone, %"class.META::Core::ComputeData"* readonly) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_seh0 to i8*) {
...
; <label>:16:                                     ; preds = %9, %2
  %17 = phi i32 [ 1, %2 ], [ %10, %9 ]
  %18 = tail call i8* @_Znwy(i64 16) #6
  %19 = bitcast i8* %18 to i32 (...)***
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [4 x i8*] }, { [4 x i8*] }* @_ZTV13MyComputeData, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %19, align 8, !tbaa !3
  %20 = getelementptr inbounds i8, i8* %18, i64 8
  %21 = bitcast i8* %20 to i32*
  store i32 %17, i32* %21, align 8, !tbaa !6
  %22 = bitcast i8* %18 to %"class.META::Core::ComputeData"*
  ret %"class.META::Core::ComputeData"* %22
}

; Function Attrs: nounwind readonly
declare dso_local i8* @__dynamic_cast(i8*, i8*, i8*, i64) local_unnamed_addr #5
...
!2 = !{!"Android (4751641 based on r328903) clang version 7.0.2 (https://android.googlesource.com/toolchain/clang 003100370607242ddd5815e4a043907ea9004281) (https://android.googlesource.com/toolchain/llvm 1d739ffb0366421d383e04ff80ec2ee591315116) (based on LLVM 7.0.2svn)"}
!3 = !{!4, !4, i64 0}
