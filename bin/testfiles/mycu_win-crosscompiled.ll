...
@_ZTSN4META4Core11ComputeDataE = linkonce_odr constant [26 x i8] c"N4META4Core11ComputeDataE\00", comdat
@_ZTIN4META4Core11ComputeDataE = linkonce_odr constant { i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv117__class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @_ZTSN4META4Core11ComputeDataE, i32 0, i32 0) }, comdat
...
@_ZTV13MyComputeUnit = unnamed_addr constant { [3 x i8*] } { [3 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI13MyComputeUnit to i8*), i8* bitcast (%"class.META::Core::ComputeData"* (%class.MyComputeUnit*, %"class.META::Core::ComputeData"*)* @_ZNK13MyComputeUnit7computeEPN4META4Core11ComputeDataE to i8*)] }, align 8
@_ZTS13MyComputeUnit = constant [16 x i8] c"13MyComputeUnit\00"
@_ZTSN4META4Core11ComputeUnitE = linkonce_odr constant [26 x i8] c"N4META4Core11ComputeUnitE\00", comdat
@_ZTIN4META4Core11ComputeUnitE = linkonce_odr constant { i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv117__class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @_ZTSN4META4Core11ComputeUnitE, i32 0, i32 0) }, comdat
...
define i32 @_ZNK13MyComputeUnit3fibEiii(%class.MyComputeUnit* nocapture readnone, i32, i32, i32) local_unnamed_addr #4 align 2 {
  %5 = icmp slt i32 %1, 1
...
; Function Attrs: uwtable
define noalias nonnull %"class.META::Core::ComputeData"* @_ZNK13MyComputeUnit7computeEPN4META4Core11ComputeDataE(%class.MyComputeUnit* nocapture readnone, %"class.META::Core::ComputeData"* readonly) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
